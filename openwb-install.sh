...
apt-get update
apt-get -q -y install vim bc apache2 php php-gd php-curl php-xml php-json libapache2-mod-php jq linux-headers-generic i2c-tools git mosquitto mosquitto-clients socat python-pip python3-pip sshpass
echo "...done"
...
if [ ! -d /var/www/html/openWB/web ]; then
	cd /var/www/html/
	git clone https://github.com/jonas-he/openWB.git --branch master
...
/var/www/html/openWB/runs/atreboot_install.sh